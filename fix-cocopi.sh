...
if grep -q "$fix" $file; then
    ...
    cp $HOME/CoCo-Pi-Installer/update/20250530/source/*.sh $HOME/source
...
if grep -q "$fix" $file; then
    ...
    cp $HOME/CoCo-Pi-Installer/update/20250624/source/*.sh $HOME/source
    cp $HOME/CoCo-Pi-Installer/update/20250624/scripts/*.sh $HOME/scripts
...
if grep -q "$fix" $file; then
    ...
    cp $HOME/CoCo-Pi-Installer/update/20250701/source/*.sh $HOME/source
...
if grep -q "$fix" $file; then
    ...
    cp $HOME/CoCo-Pi-Installer/update/20250803/source/*.sh $HOME/source
...
if grep -q "$fix" $file; then
    ...
    cp $HOME/CoCo-Pi-Installer/update/20250926/source/*.sh $HOME/source
