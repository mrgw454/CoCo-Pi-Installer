...
wget https://gcc.gnu.org/pub/gcc/releases/gcc-4.6.4/gcc-4.6.4.tar.bz2
...
echo
cd gcc-4.6.4
patch -p1 <../lwtools/extra/gcc6809lw-4.6.4-10.patch
echo
...
# new fix
sed -i '/^@tab General: @tex press@@gnu.org @end tex$/{
s/@tex //;
s/@end tex//
}' gcc-4.6.4/gcc/doc/gcc.texi

sed -i '/^@tab Orders:  @tex sales@@gnu.org @end tex$/{
s/@tex //;
s/@end tex//
}' gcc-4.6.4/gcc/doc/gcc.texi
...
#@end tex\
#@end multitable\
#@end titlepage' gcc-4.6.4/gcc/doc/gcc.texi
