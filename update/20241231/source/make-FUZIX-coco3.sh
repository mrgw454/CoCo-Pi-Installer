...
# force 80 column mode as default
# delete this line
#sed -i '/is_rgb = */d' $HOME/source/FUZIX-coco3/Kernel/platform/platform-coco3/devtty.c

# add this to replace it
#sed -i '/keyrepeat.continual =/a is_rgb = 1;' $HOME/source/FUZIX-coco3/Kernel/platform/platform-coco3/devtty.c
