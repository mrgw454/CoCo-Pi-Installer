...
xroar -c $HOME/.xroar/xroar.conf -default-machine coco2bus -machine-cart ide -load-hd0 $HOME/.xroar/hd0.img -type 'N\rDRIVE I 1,4,3\rDRIVE U 0\rDRIVE M 0,1,0,0,0\rDRIVE M 1,0,0\rDRIVE M 2,0,1\rDRIVE I:DRIVE M\rLOAD"WIDTH32.BAS:1"\rRUN\r' -v 2 $XROARPARMS
