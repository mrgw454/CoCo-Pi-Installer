...
xroar -c $HOME/.xroar/xroar.conf -default-machine coco3h -machine-cart ide -load-hd0 $HOME/.xroar/hd0.ide -type 'N\r\0DRIVE I 1,4,3\r\0DRIVE U 0\r\0DRIVE M 0,1,0,0,0\r\0DRIVE M 1,0,0\r\0DRIVE M 2,0,1\r\0DRIVE I:DRIVE M\r\0\0\0\0LOAD"WIDTH80.BAS:1"\r\0RUN\r' $XROARPARMS
