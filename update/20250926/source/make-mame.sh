...
# this package causes a compilation error due to the core.h header file
sudo apt remove libpipewire-0.3-dev
...
#make --debug=v -j$cores VERBOSE=1 TOOLS=1 NOWERROR=1
make -j$cores VERBOSE=1 TOOLS=1 NOWERROR=1
