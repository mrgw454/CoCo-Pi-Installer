...
# compile PNGtoCCSB 2 tool
$HOME/source/QB64pe/qb64pe -c -o "PNGtoCCSB 2" "PNGtoCCSB 2.bas"

if [ ! -f "PNGtoCCSB 2" ]; then
        echo
        echo Compiling of "PNGtoCCSB 2" tool failed.  Aborting.
        echo
        exit 1
fi
