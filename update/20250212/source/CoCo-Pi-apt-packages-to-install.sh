...
sudo apt -y install glances neofetch net-tools dos2unix screenfetch screen psmisc curl nala xterm wget xfsprogs rmlint fdupes
...
sudo apt -y install libsdl2-mixer-dev install libsmpeg-dev libsdl-ttf2.0-dev libsdl-net1.2-dev hexedit wxhexeditor hexyl ghex wkhtmltopdf
