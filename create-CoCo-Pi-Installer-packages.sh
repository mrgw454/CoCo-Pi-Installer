...
tar czvf $stagingfolder/source.tar.gz source/new_windows.zip source/*.sh source/useroptions.mak ovcc-patch-package-cc936b2.tar.gz source/coco3-jaggies-patches.zip
